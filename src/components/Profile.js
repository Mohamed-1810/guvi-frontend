...
function Profile() {
    ...
    // window.location.reload({sessionStorage.removeItem('mySessionVariable'))
    useEffect(() => {
        // axios.get('https://guvi-api-3.onrender.com/')
    ...
    const handleSubmit = (event) => {
        ...
        axios.post('https://guvi-api-5.onrender.com/profile', values)
